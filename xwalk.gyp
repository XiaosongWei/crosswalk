  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'runtime/renderer/android/xwalk_web_graphics_context3d_direct.h',
        'runtime/renderer/android/xwalk_web_graphics_context3d_direct_impl.cc',
        'runtime/renderer/android/xwalk_web_graphics_context3d_direct_impl.h',
