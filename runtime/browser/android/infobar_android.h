...
#ifndef XWALK_RUNTIME_BROWSER_ANDROID_INFOBAR_ANDROID_H_
#define XWALK_RUNTIME_BROWSER_ANDROID_INFOBAR_ANDROID_H_
...
#endif  // XWALK_RUNTIME_BROWSER_ANDROID_INFOBAR_ANDROID_H_
